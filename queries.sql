...
insert into user_role(role_id, role_name) values(2, 'Manager');
...
create table products(
	...
	name varchar(50),
	fk_brand_id int(10),
	fk_supplier_id int(10),
	fk_category_id int(10),
	net_weight float(10),
...
insert into products(code, sku, name, fk_brand_id, fk_supplier_id, fk_category_id, net_weight, sales_price, purchase_cost, stock_level, fk_uom_id) values('rand-code', 'rand-sku-ZZ11', 'Pran Chilli Powder (Jar)', 6, 1, 8, 250, 90, 85, 50, 3);
insert into products(code, sku, name, fk_brand_id, fk_supplier_id, fk_category_id, net_weight, sales_price, purchase_cost, stock_level, fk_uom_id) values('rand-code', 'rand-sku-ZZ00', 'ACI Pure Halim Mix', 6, 1, 8, 200, 45, 35, 50, 3);





select p.name 'Product name', b.name 'brand', c.name 'category', s.name 'supplier', u.name 'uom' from products p, brands b, product_category c, suppliers s, uom u where p.fk_brand_id = b.id and p.fk_supplier_id = s.id and p.fk_category_id = c.id and p.fk_uom_id = u.id;
